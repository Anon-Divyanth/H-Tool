...
# Evil Url:
def EvilUrl():
    print (system("cd $HOME && git clone https://github.com/UndeadSec/EvilURL.git"))
# lowbait:
def lawbait():
...
# Trity:
def Trity():
    print (system("cd $HOME && git clone https://github.com/toxic-ig/Trity.git"))
# Inshackle:
def Inshackle():
    print (system("cd $HOME && git clone https://github.com/xd20111/inshackle"))
# Devploit:
...
# E-Bomber:
def EBomber():
    print (system("cd $HOME && git clone https://github.com/EH30/E-bomber"))
# EMBomber:
def EMBomber():
    print (system("cd $HOME && git clone https://github.com/MazenElzanaty/EmBomber.git"))
# Avarspam:
def Avarspam():
...
# onex:
def onex():
    print (system("cd $HOME && git clone https://github.com/rajkumardusad/onex.git"))
# Dark-fly:
def Darkfly():
